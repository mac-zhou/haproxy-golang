...
type ClientService interface {
	...
	CreateRuntimeMap(params *CreateRuntimeMapParams, authInfo runtime.ClientAuthInfoWriter) (*CreateRuntimeMapCreated, *CreateRuntimeMapAccepted, error)
...
*/
func (a *Client) CreateRuntimeMap(params *CreateRuntimeMapParams, authInfo runtime.ClientAuthInfoWriter) (*CreateRuntimeMapCreated, *CreateRuntimeMapAccepted, error) {
	// TODO: Validate the params before sending
	if params == nil {
	...
	case *CreateRuntimeMapCreated:
		return value, nil, nil
	case *CreateRuntimeMapAccepted:
