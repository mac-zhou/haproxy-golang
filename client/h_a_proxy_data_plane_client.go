...
import (
	...
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/acl"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/backend"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/backend_switching_rule"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/bind"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/cluster"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/configuration"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/defaults"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/discovery"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/filter"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/frontend"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/global"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/http_request_rule"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/http_response_rule"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/information"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/log_target"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/maps"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/nameserver"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/peer"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/peer_entry"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/reloads"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/resolver"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/server"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/server_switching_rule"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/service_discovery"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/sites"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/specification"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/specification_openapiv3"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/stats"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/stick_rule"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/stick_table"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/tcp_request_rule"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/tcp_response_rule"
	"mac_zhou.exe/go/pkg/mod/github.com/mac-zhou/haproxy-golang/client/transactions"
)
